                ...
                <div class="table-responsive">
                    ...
                    <table class="table table-responsive table-hover table-bordered" >
                        ...
                        <tr>
                            ...
                            <td class="total-amount"><?php echo LANG_VALUE_1; ?><?php     
                            $cost1 = 50;
                            $cost2 = 100;
                            $cost3 = 150;
                            $cost4 = 250;
                            if($table_total_price <= 500){
                                echo $cost1;
                            }
                            else if($table_total_price >= 500 && $table_total_price <= 1000){
                                echo $cost2;
                            }
                            else if($table_total_price >= 1000 && $table_total_price <= 1500){
                                echo $cost3;
                            }
                            else{
                                echo $cost4; 
                        ...
                        <tr>
                            ...
                            <th class="total-amount">
                                ...
                                $cost4 = 250;
                                if($table_total_price <= 500){
                                    $final_total = $table_total_price+$cost1;
                                }
                                else if($table_total_price >= 500 && $table_total_price <= 1000){
                                    $final_total = $table_total_price+$cost2;
                                }
                                else if($table_total_price >= 1000 && $table_total_price <= 1500){
                                    $final_total = $table_total_price+$cost3;
                                }
                                else{
                                    $final_total = $table_total_price+$cost4; 
                                }
	                            ...
	                            <div class="row">
                                    ...
                                    <form action="payment/bank/init.php" method="post" id="bank_form" >
                                        ...
                                        <div class="col-md-12 form-group">
                                            ...
                                            <textarea name="transaction_info" class="form-control"  rows="3" required></textarea>
                                        </div>
                                        <div class="col-md-12 form-group">
                                            <input type="submit" class="btn btn-primary" value="<?php echo LANG_VALUE_46; ?>" name="form3">
                                        </div>
                                    </form>
                                    <form action="payment/airtel/init.php" method="post" id="airtel_form" >
                                        <input type="hidden" name="amount" value="<?php echo $final_total; ?>">
                                        <div class="col-md-12 form-group">
                                            <label for=""><?php echo LANG_VALUE_43; ?></span></label><br>
                                            <?php
                                    ...
                                    <form action="payment/mtn/init.php" method="post" id="mtn_form" >
                                        <input type="hidden" name="amount" value="<?php echo $final_total; ?>">
                                        <div class="col-md-12 form-group">
                                            <label for=""><?php echo LANG_VALUE_43; ?></span></label><br>
                                            <?php
