...
<div class="product pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2 style="font-size:25px;"><?php echo $featured_product_title; ?></h2>
                    <h3 style="font-size:15px;"><?php echo $featured_product_subtitle; ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <div class="item" style="height:300px;overflow:hidden">
                        <div class="thumb">
                            <div class="photo"
                                style="background-image:url(assets/uploads/<?php echo $row['p_featured_photo']; ?>);height:150px;width:150px;display: block;margin-left: auto;margin-right: auto;width: 50%;">
                            </div>
...
<div class="product bg-gray pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2 style="font-size:25px;"><?php echo $latest_product_title; ?></h2>
                    <h3 style="font-size:15px;"><?php echo $latest_product_subtitle; ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
            <div class="col-md-12">
                ...
                <div class="product-carousel">
                    ...
                    <?php
                    $statement = $pdo->prepare("SELECT * FROM tbl_product WHERE p_is_active=? ORDER BY p_total_view DESC LIMIT ".$total_latest_product_home);
...
<div class="product pt_70 pb_70">
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                <div class="headline">
                    <h2 style="font-size:25px;"><?php echo $popular_product_title; ?></h2>
                    <h3 style="font-size:15px;"><?php echo $popular_product_subtitle; ?></h3>
                </div>
            </div>
        </div>
        <div class="row">
