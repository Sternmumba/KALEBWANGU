                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown user user-menu">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                                ...
                                <span class="hidden-xs">Stern Mumba</span>
                            </a>
                            <ul class="dropdown-menu">
                                <!-- User image -->
                            ...
                            <a href="javascript:void(0)">
                                ...
                                <div class="menu-info">
                                    <h4 class="control-sidebar-subheading">
                                        SM Techrone innovation's Birthday
                                    </h4>

                                    <p>Will be 1 on Dec 21th</p>
                                </div>
                            </a>
                        </li>
                        <li>
                            <a href="javascript:void(0)">
                                ...
                                <div class="menu-info">
                                    <h4 class="control-sidebar-subheading">
                                        Mwansa Updated His Profile
                                    </h4>

                                    <p>New phone +26067 0202466</p>
                                </div>
                            </a>
                        </li>
                        <li>
